...
<header>
      ...
      <nav>  
        ...
        <main>
        <div class='info'><?php echo $startError ?></div>
         <fieldset>
        <legend>Indtast oplysninger</legend>
            <form method='post' action='indtast.php'>
                <label for='name'>Name: </label><br />
                <input id='text' type='text' name='Name' /> <span class='error'><?php echo $nameError ?></span><br />
                <label for='email'>Email: </label><br />
                <input id='text' type='text' name='Email' /> <span class='error'><?php echo $emailError?></span> <br />
                
                <br />
                <label for='Age'>Age: </label>
                <input id='shoe' type='text' name='Age' /> <label id='shoeSize' for='shoeSize'>Shoe Size: </label>
                <input id='shoe' type='text' name='shoeSize' /> <span class='error'><?php echo $ageError ?></span><br />
